    ...
    <div className="min-h-screen bg-background flex items-center justify-center py-12 px-4">
      <div className="max-w-6xl w-full">
        ...
        >
          ...
          {/* Right Panel - Info */}
          <div className="hidden lg:block bg-gradient-to-br from-primary via-primary-glow to-accent text-white p-12 relative overflow-hidden">
            {/* Background Pattern */}
            ...
            <div className="relative z-10 h-full flex flex-col justify-center space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold">Activity-Specific</h3>
